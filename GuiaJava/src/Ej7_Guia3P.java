...
public class Ej7_Guia3P {
    ...
    public static void main(String[] args) {
       ...
       do {
           ...
           if ("x".equalsIgnoreCase(frase.substring(0, 1)) && "o".equalsIgnoreCase(frase.substring(frase.length()-1,frase.length())) && frase.length() <= 5)
           {
               cont1++;
       ...
       } while(!"&&&&&".equals(frase)); // frase != "&&&&&" >> eso es solo para numeros
       
        System.out.println("La cantidad de códigos correctos es: " + cont1);
        System.out.println("La cantidad de códigos incorrectos es: " + (cont2 -1) );
    }
